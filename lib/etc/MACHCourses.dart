...
class _MACHCourseDialogState extends State<MACHCourseDialog> {
  ...
  void initState() {
    ...
    _getSubjectsSemesterFuture = getSubjectsSemester(
        db, auth, "machCourseDialog", _selectedSemester, _subjectNames);
  }
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if (semester != '0-0') {
                                await setSubject(db, auth, "machCourseDialog",
                                    "디지털 기업경영", 0, semester!);
                              } else {
                                await deleteSubject(
                                    db, auth, "machCourseDialog", "디지털 기업경영");
                              }
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if (semester != '0-0') {
                                await setSubject(db, auth, "machCourseDialog",
                                    "창의적 디자인사고와 비즈니스모델", 0, semester!);
                              } else {
                                await deleteSubject(db, auth,
                                    "machCourseDialog", "창의적 디자인사고와 비즈니스모델");
                              }
                              await getSubjectSemester(
                                  db,
                                  auth,
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if (semester != '0-0') {
                                await setSubject(db, auth, "machCourseDialog",
                                    "플랫폼과 뉴비즈니스", 0, semester!);
                              } else {
                                await deleteSubject(
                                    db, auth, "machCourseDialog", "플랫폼과 뉴비즈니스");
                              }
                              await getSubjectSemester(
                                  db,
                                  auth,
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if (semester != '0-0') {
                                await setSubject(db, auth, "machCourseDialog",
                                    "공감의 스토리텔링", 0, semester!);
                              } else {
                                await deleteSubject(
                                    db, auth, "machCourseDialog", "공감의 스토리텔링");
                              }
                              await getSubjectSemester(
                                  db,
                                  auth,
