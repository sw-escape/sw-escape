...
class _MajorRequiredPageState extends State<MajorRequiredPage> {
  ...
  final _subjectNames = ["자료구조", "컴퓨터구조", "프로그래밍언어론", "소프트웨어공학", "알고리즘", "운영체제"];
  ...
  void initState() {
    ...
    _getSubjectsSemesterFuture = getSubjectsSemester(db, auth, _selectedSemester, _subjectNames);
  }
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if(semester != '0-0') {
                                await setSubject(db, auth, "majorRequired", "자료구조", 3, semester!);
                              } else {
                                await deleteSubject(db, auth, "majorRequired", "자료구조");
                              }
                              await getSubjectSemester(db, auth, "majorRequired", _selectedSemester, 0, "자료구조");
                              setState(() {
                                // 리빌드
                              });
                            },
                      ...
                      trailing: Container(
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if(semester != '0-0') {
                                await setSubject(db, auth, "majorRequired", "컴퓨터구조", 3, semester!);
                              } else {
                                await deleteSubject(db, auth, "majorRequired", "컴퓨터구조");
                              }
                              await getSubjectSemester(db, auth, "majorRequired", _selectedSemester, 1, "컴퓨터구조");
                              setState(() {
                                // 리빌드
                              });
                            },
                      ...
                      trailing: Container(
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if(semester != '0-0') {
                                await setSubject(db, auth, "majorRequired", "프로그래밍언어론", 3, semester!);
                              } else {
                                await deleteSubject(db, auth, "majorRequired", "프로그래밍언어론");
                              }
                              await getSubjectSemester(db, auth, "majorRequired", _selectedSemester, 2, "프로그래밍언어론");
                              setState(() {
                                // 리빌드
                              });
                            },
                      ...
                      trailing: Container(
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if(semester != '0-0') {
                                await setSubject(db, auth, "majorRequired", "소프트웨어공학", 3, semester!);
                              } else {
                                await deleteSubject(db, auth, "majorRequired", "소프트웨어공학");
                              }
                              await getSubjectSemester(db, auth, "majorRequired", _selectedSemester, 3, "소프트웨어공학");
                              setState(() {
                                // 리빌드
                              });
                            },
                      ...
                      trailing: Container(
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if(semester != '0-0') {
                                await setSubject(db, auth, "majorRequired", "알고리즘", 3, semester!);
                              } else {
                                await deleteSubject(db, auth, "majorRequired", "알고리즘");
                              }
                              await getSubjectSemester(db, auth, "majorRequired", _selectedSemester, 4, "알고리즘");
                              setState(() {
                                // 리빌드
                              });
                            },
                      ...
                      trailing: Container(
                        ...
                        child: Center(
                          child: DropdownButton(
                            ...
                            onChanged: (semester) async {
                              if(semester != '0-0') {
                                await setSubject(db, auth, "majorRequired", "운영체제", 3, semester!);
                              } else {
                                await deleteSubject(db, auth, "majorRequired", "운영체제");
                              }
                              await getSubjectSemester(db, auth, "majorRequired", _selectedSemester, 5, "운영체제");
                              setState(() {
                                // 리빌드
                              });
                            },
